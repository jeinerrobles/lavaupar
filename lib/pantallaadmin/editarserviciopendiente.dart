...
class EditarServicioPendiente extends StatefulWidget {
  ...
  EditarServicioPendiente(this.idservicio, this.nombre,this.direccion, this.fecha, this.cliente, this.estado);
  @override
  _EditarServicioPendienteState createState() => _EditarServicioPendienteState();
}

class _EditarServicioPendienteState extends State<EditarServicioPendiente> {
  var idservicio;
